<?php
   class MySQL{
   		...
   		function connect(){
   			$this->link = mysql_conennect($this->host,$this->user,
   			$this->password)
   			if (!this->link){
	...
	function inserirAluno($nome,$datNasc,$foto){
		$sqlAluno = "inserir into aluno (nome,datNasc,foto) VALUE ('$nome','$datNasc',"$foto')";
